...
void roads_draw_confront_comb248__sf(string file_list){
	...
	mg->SetTitle("road eff "+TString(name_sf[3])+" "+TString(name_sf[4])+"; # road truncation; # avg stubs combinations");
...
//		eff[i]->SetName(eff_name);
		eff[i]->Draw("comb_mean:road_truncation","","goff"); //what leafs to plot

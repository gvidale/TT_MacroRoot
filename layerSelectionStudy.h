...
// Fri Aug 11 15:13:37 2017 by ROOT version 5.34/36
// from TTree tree/
// found on file: /home/rossin/data/EOS/920/SingleMu/WholeTracker/170613_044226/PGun_pt2_Tilted_TkOnly_ntuple_cleaned.root
//////////////////////////////////////////////////////////

#ifndef layerSelectionStudy_h
#define layerSelectionStudy_h
...
public :
   ...
   layerSelectionStudy(TTree *tree=0);
   virtual ~layerSelectionStudy();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(UInt_t nEv);
...
#ifdef layerSelectionStudy_cxx
layerSelectionStudy::layerSelectionStudy(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("wholetracker_cleaned_0822.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("wholetracker_cleaned_0822.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("wholetracker_cleaned_0822.root:/ntupler");
      /* TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/rossin/data/EOS/920/SingleMu/WholeTracker/170613_044226/PGun_pt2_Tilted_TkOnly_ntuple_cleaned.root"); */
      /* if (!f || !f->IsOpen()) { */
      /*    f = new TFile("/home/rossin/data/EOS/920/SingleMu/WholeTracker/170613_044226/PGun_pt2_Tilted_TkOnly_ntuple_cleaned.root"); */
      /* } */
      /* TDirectory * dir = (TDirectory*)f->Get("/home/rossin/data/EOS/920/SingleMu/WholeTracker/170613_044226/PGun_pt2_Tilted_TkOnly_ntuple_cleaned.root:/ntupler"); */
...
layerSelectionStudy::~layerSelectionStudy()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t layerSelectionStudy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t layerSelectionStudy::LoadTree(Long64_t entry)
{
...
void layerSelectionStudy::Init(TTree *tree)
{
...
Bool_t layerSelectionStudy::Notify()
{
...
void layerSelectionStudy::Show(Long64_t entry)
{
...
Int_t layerSelectionStudy::Cut(Long64_t entry)
{
...
#endif // #ifdef layerSelectionStudy_cxx

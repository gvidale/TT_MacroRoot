...
void readtree_roads_densitystubs41(TString name = "0", TString key = "0",Int_t charge=1){
	...
	if(key.Index("cmseos")!=-1) fName = "root://cmsxrootd.fnal.gov//store/user/gvidale/TT41/"+name+".root"; //for eos file in my home
	...
	f = new TFile("../roads/TT41/"+name+"_stub_density_ss20-220.root","RECREATE");
